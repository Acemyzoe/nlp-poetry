...
def main():
	...
	parser.add_argument('-w','--weights',type = str,help = "Model weights to be loaded.",default = "../model/weights-500-3-0.2/weights-improvement-174-2.9403.hdf5")
	parser.add_argument('-m','--model',type = str,help = "LSTM Model to be loaded.",default = "../model/weights-500-3-0.2/model-500-3-0.2.h5")
