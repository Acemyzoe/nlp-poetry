...
def main():
	...
	processedData = open("../data/data_five_character_quatrains简体.txt", 'w', encoding='utf-8')
	processedData_mix = open("../data/data_mixed简体.txt", 'w', encoding='utf-8')
	vocabulary_f = open("../data/vocabulary_frequency简体.txt", 'w', encoding='utf-8')
	...
	data_file.close()
	print("preprocessed:%d"%len(preprocessed))
	print("preprocessed_mixed:%d"%len(preprocessed_mixed))
	print("vocabulary:%d"%len(vocabulary))
		
	# s = ["明月出天山，蒼茫雲海間○。", "明月出天山，蒼茫雲海間。"]
	# print("○" in s[0])
def washing(preprocessed, data, preprocessed_mixed, vocabulary, zh2Hans, zh2Hant):
	symbol = "·！（）[]「」{}《》？-1234567890=+|/。●〖〗"
	for shi in data:
